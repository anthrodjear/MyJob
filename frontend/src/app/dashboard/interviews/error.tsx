/**
 * Interviews error boundary — catches and displays errors from the interviews route.
 *
...
interface InterviewsErrorProps {
...
function getUserMessage(error: Error): string {
  ...
  return "Something went wrong loading interviews.";
}
...
export default function InterviewsError({ error, reset }: InterviewsErrorProps) {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl font-semibold">Failed to load interviews</h2>
